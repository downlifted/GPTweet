...
`;
const Container = styled_components_browser_esm.div `
    width: 600px;
    padding: 35px 25px;
    border-radius: 10px;
    ...
    flex-direction: column;
`;
const Logo = styled_components_browser_esm.img `
    width: 80px;
    height: 80px;
    margin-bottom: 25px;
`;
const SettingsBlock = styled_components_browser_esm.div `
    width: 100%;
    margin-top: 25px;
    display: flex;
    justify-content: flex-start;
...
;// CONCATENATED MODULE: ./src/settings/components/checkbox.tsx
...
const Checkbox = ({ value, label, onChange }) => {
    ...
    return (react.createElement(checkbox_Container, { onClick: () => onChange(!value) },
        react.createElement("div", { className: 'iconContainer' },
            react.createElement(Icon, { src: src }),
            react.createElement(CheckboxSquare, { type: "checkbox", name: label, checked: value })),
        react.createElement(Label, { htmlFor: label }, label)));
};
const checkbox_Container = styled_components_browser_esm.div `
    cursor: pointer;
...
`;
const CheckboxSquare = styled_components_browser_esm.input `
    position: absolute;
    left: 0;
    top: 0;
    width: 100%;
    ...
    cursor: pointer;
`;
const Icon = styled_components_browser_esm.img `
    width: 18px;
    height: 18px;
`;
const Label = styled_components_browser_esm.label `
    margin-left: 10px;
    font-size: 15px;
    cursor: pointer;
    color: #181C21;
...
;// CONCATENATED MODULE: ./src/settings/components/selector.tsx


const Selector = ({ value, onChange, options }) => {
    return (react.createElement(selector_Container, null,
        react.createElement(Select, { value: value, onChange: e => onChange(e.target.value) }, options.map(option => (react.createElement("option", { key: option.value, value: option.value }, option.label))))));
};
const selector_Container = styled_components_browser_esm.div `
    border: 1px solid #ccc;
    border-radius: 3px;
    padding-right: 10px;
    width: 100%;
`;
const Select = styled_components_browser_esm.select `
    border-radius: 3px;
    border-width: 0;
    padding: 7px 10px;
    font-size: 15px;
...
;// CONCATENATED MODULE: ./src/settings/components/text_input.tsx

const TextInput = styled_components_browser_esm.input `
    box-sizing: border-box;
    width: 100%;
    height: 40px;
    padding: 0 10px;
...
;// CONCATENATED MODULE: ./src/settings/components/text.tsx

const H1 = styled_components_browser_esm.h1 `
    font-size: 25px;
    font-weight: bold;
    color: #181C21;
    margin: 0;
`;
const H2 = styled_components_browser_esm.h2 `
    font-size: 18px;
    font-weight: 600;
    color: #181C21;
    margin: 0;
`;
const Subtitle = styled_components_browser_esm.span `
    font-size: 15px;
    color: #566370;
...
;// CONCATENATED MODULE: ./src/settings/components/space.tsx

const Space = styled_components_browser_esm.div((props) => `
...
;// CONCATENATED MODULE: ./src/settings/settings_screen.tsx
...
const SettingsScreen = () => {
    const logoPath = (0,react.useMemo)(() => chrome.runtime.getURL('icons/128.png'), []);
    const [openAIToken, setOpenAIToken] = (0,react.useState)('');
    const [selectedLanguage, setLanguage] = (0,react.useState)(defaultLocale);
    const [isAddSignature, setAddSignature] = (0,react.useState)(true);
    const [isAddTopicForReplies, setTopicForReplies] = (0,react.useState)(false);
    const changeOpenAIToken = (0,react.useCallback)(async (newToken) => {
        await chrome.storage.local.set({ openAIToken: newToken });
        setOpenAIToken(newToken);
    }, []);
    const changeSignature = (0,react.useCallback)(async (isNewAddSignature) => {
    ...
    const changeTopic = (0,react.useCallback)(async (isAddTopicForReplies) => {
        await chrome.storage.local.set({ isAddTopicForReplies });
        setTopicForReplies(isAddTopicForReplies);
    }, []);
    const changeLanguage = (0,react.useCallback)(async (language) => {
    ...
    const languageOptions = (0,react.useMemo)(() => {
    ...
    const warning = (0,react.useMemo)(() => {
        return openAIToken.length === 0 ? '⚠️' : '';
    }, [openAIToken === '']);
    return (react.createElement(Body, null,
        react.createElement(Logo, { src: logoPath }),
        react.createElement(Container, null,
            react.createElement(H1, null, "TweetGPT Settings"),
            react.createElement(SettingsBlock, null,
                react.createElement(H2, null,
                    "HuggingFace API Token ",
                    warning),
                react.createElement(Space, { height: 3 }),
                react.createElement(Subtitle, null,
                    "Required. You can find your Secret API key in your ",
                    react.createElement("a", { href: "https://huggingface.co/settings/tokens" }, "HuggingFace User settings"),
                    "."),
                react.createElement(Space, { height: 10 }),
                react.createElement(TextInput, { type: "password", placeholder: 'Put your secret API token here', value: openAIToken, onChange: (e) => changeOpenAIToken(e.target.value) })),
            react.createElement(SettingsBlock, null,
                react.createElement(H2, null, "Text Generation"),
                react.createElement(Space, { height: 10 }),
                react.createElement(Checkbox, { value: isAddSignature, onChange: changeSignature, label: 'Add TweetGPT Signature' }),
                react.createElement(Space, { height: 10 }),
                react.createElement(Checkbox, { value: isAddTopicForReplies, onChange: changeTopic, label: 'Ask for tweet topic in replies' })),
            react.createElement(SettingsBlock, null,
                react.createElement(H2, null, "Language"),
                react.createElement(Space, { height: 10 }),
                react.createElement(Selector, { value: selectedLanguage, onChange: changeLanguage, options: languageOptions })))));
};

;// CONCATENATED MODULE: ./src/settings/settings.tsx



const root = (0,client/* createRoot */.s)(document.getElementById('root'));
root.render(react.createElement(SettingsScreen, null));
